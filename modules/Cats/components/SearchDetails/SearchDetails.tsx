  ...
  return (
    <div className={styles.search_header}>
      <div className="flex flex-col sm:flex-row sm:space-x-2">
        ...
        <Switcher value={searchParams?.get('mime_types')} name="mime_types" options={sizeOptions} onSwitchChange={handleSwitchChange} />
      </div>
      <div className="flex flex-col sm:flex-row sm:space-x-2">
        <Label text="Choose size" />
        <Switcher value={searchParams?.get('size')} name="size" options={mimeTypesOptions} onSwitchChange={handleSwitchChange} />
      </div>
      <div className="flex flex-col sm:flex-row sm:space-x-2">
        <Label text="Choose order" />
        <Switcher value={searchParams?.get('order')} name="order" options={orderOptions} onSwitchChange={handleSwitchChange} />
      </div>
    </div>
  );
}
